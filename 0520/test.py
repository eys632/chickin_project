...
# ... 기존 YOLO 결과 처리 루프 내에서 각 box 처리할 때
    for i, box in enumerate(boxes):
        ...
        print(f"\n[프레임 {frame_idx}] Box {i}: YOLO ID = {yolo_id}")
